...
public class EndFrame extends JFrame
{
    ...
    public ArrayList<LevelInterface> levelInterfaces ;
    ...
    public EndFrame(GameFrame gameFrame)
    {
        ...
        this.levelInterfaces = LoginFrame.levelInterfaces;
        ...
        restartBtn.addActionListener(e ->
        {
            ...
            {
                gameFrame.getAdvancedTimeLabel().setText(String.format("Time: %02d : %02d", gameFrame.getTimeAttack() / 60, gameFrame.getTimeAttack() % 60));
            }
            else if (gameFrame.getTimeMode() == 0)
            {
                gameFrame.getAdvancedTimeLabel().setText("Time: 00 : 00");
            }
