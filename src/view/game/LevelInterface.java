...
//            {{10, 11, 20, 20, 0}, {40, 40, 21, 21, 30}, {40, 40, 22, 22, 30}, {12, 13, 23, 23, 0}}
 // for code testing
    ...
    public LevelInterface(LoginFrame loginFrame) {
        ...
        levelPanel = FrameUtil.createPanel(this, new Point(getWidth() / 2 - 350, getHeight() / 2 - 200), 720, 400, Color.LIGHT_GRAY);
//        levelNamePanel = FrameUtil.createPanel(this, new Point(getWidth() / 2 - 400, getHeight() / 2 - 430), 800, 100, Color.DARK_GRAY);
        ...
        normalModeGameBtn.addActionListener(e ->
        {
            ...
            levelGameFrame.getAdvancedTimeLabel().setText(String.format("Time: %02d : %02d", 0, 0));

            JPanel gameFrameImage = new JPanel();
            gameFrameImage.setSize(1200, 900);
            FrameUtil.setPanelImage(gameFrameImage, "gameFrame.png");
            levelGameFrame.add(gameFrameImage);
        ...
        timeAttackModeBtn.addActionListener(e ->
        {
            ...
            // There is no correct timeAttack when newing levelGameFrame
            levelGameFrame.getAdvancedTimeLabel().setText(String.format("Time: %02d : %02d", levelGameFrame.getTimeAttack() / 60, levelGameFrame.getTimeAttack() % 60));
